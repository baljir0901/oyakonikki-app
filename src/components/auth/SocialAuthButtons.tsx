  ...
  return (
    <div className="space-y-4">
      <Button
        ...
        className="w-full h-14 text-base border-2 border-amber-200/50 hover:border-amber-300 bg-white/70 hover:bg-white/90 backdrop-blur-sm rounded-2xl font-medium transition-all duration-300 group shadow-lg hover:shadow-xl"
      >
        <div className="flex items-center justify-center gap-3">
          <div className="w-6 h-6 bg-white rounded-lg p-1 shadow-sm group-hover:scale-110 transition-transform duration-200">
          ...
          <span className="text-amber-800 group-hover:text-amber-900">Googleでログイン</span>
        </div>
      </Button>
      ...
      <Button
        ...
        className="w-full h-14 text-base border-2 border-amber-200/50 hover:border-green-300 bg-white/70 hover:bg-green-50/90 backdrop-blur-sm rounded-2xl font-medium transition-all duration-300 group shadow-lg hover:shadow-xl"
      >
        <div className="flex items-center justify-center gap-3">
          <div className="w-6 h-6 bg-green-500 rounded-lg p-1 shadow-sm group-hover:scale-110 transition-transform duration-200">
            <svg className="w-full h-full" viewBox="0 0 24 24">
              <path
                fill="white"
          ...
          <span className="text-amber-800 group-hover:text-green-800">LINEでログイン</span>
        </div>
      </Button>
    </div>
  );
